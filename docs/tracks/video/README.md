...
### Medium — occluded crossing

![Occluded-crossing reference, GPT-5.4 reconstruction, and GPT-5.6 Luna reconstruction](../../assets/video/occluded-crossing-comparison.gif)

[Reference MP4](../../../benchmarks/video/samples/seed_v1/occluded-crossing.mp4) · [GPT-5.4 MP4](../../assets/video/occluded-crossing-gpt-5.4-low.mp4) · [GPT-5.6 Luna MP4](../../assets/video/occluded-crossing-luna-low.mp4)

### Hard — articulated motion

![Articulated-motion reference, GPT-5.4 reconstruction, and GPT-5.6 Luna reconstruction](../../assets/video/articulated-motion-comparison.gif)

[Reference MP4](../../../benchmarks/video/samples/seed_v1/articulated-motion.mp4) · [GPT-5.4 MP4](../../assets/video/articulated-motion-gpt-5.4-low.mp4) · [GPT-5.6 Luna MP4](../../assets/video/articulated-motion-luna-low.mp4)

Both models used low reasoning through the OpenAI Responses API. Every published episode had a fresh context and fresh offline 2 GB container. The original three simple tasks used a 15-turn ceiling; medium and hard used 25 after calibration. Every published run finished in 12 turns or fewer, so neither ceiling bound a reported result. Both models submitted all five videos.
...
| Occluded crossing | 0.8638 | 0.8118 | **0.9227** | **0.8903** |
| Articulated motion | 0.8128 | 0.7383 | **0.8538** | **0.8219** |
| **Mean** | 0.9008 | 0.8595 | **0.9272** | **0.9072** |

**Match** is the mean over 175 hidden frames; **final** applies the shared output-token penalty. Across five tasks, GPT-5.4 averaged 3,064 output tokens and 9.6 turns. Luna averaged 2,002 output tokens and 4.8 turns. The difference between visible and hidden performance is deliberate: frames shown to the model never contribute to match.

The remaining full-quality comparisons are available directly: [elastic reference](../../../benchmarks/video/samples/seed_v1/elastic-bounce.mp4), [GPT-5.4](../../assets/video/elastic-bounce-gpt-5.4-low.mp4), [Luna](../../assets/video/elastic-bounce-luna-low.mp4); and [gravity reference](../../../benchmarks/video/samples/seed_v1/gravity-fall.mp4), [GPT-5.4](../../assets/video/gravity-fall-gpt-5.4-low.mp4), [Luna](../../assets/video/gravity-fall-luna-low.mp4).

During harness calibration, three earlier GPT-5.4 attempts rendered files but reached then-current turn cutoffs before submission: two simple-task attempts at 8 and 10 turns, and one medium attempt at 15. SymPy was also missing in the first attempt. Those unscored calibration runs are not included above. SymPy was added and the current Video ceiling was fixed at 25 turns; the token penalty and 20-minute timeout remain unchanged. This is a small systems baseline, not a broad model ranking.
...
- **Occluded crossing** — a circle and rotating square follow independent paths behind a pillar.
- **Articulated motion** — a moving anchor drives a two-link mechanism with coupled rotations.
...
An unfrozen [Video v0.2 candidate set](../../../benchmarks/video/candidates/v0.2/README.md) adds low-resolution easy, medium, and hard calibration scenes above the single-object tasks. Its difficulty labels remain provisional until model-panel results demonstrate useful separation.
